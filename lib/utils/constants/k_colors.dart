...
class KColors {
  static const Color scaffoldBackgroundColor = Color(0xff101d25);
  static const Color appbarColor = Color(0xff222c36);
  ...
  static const Color switchColor = Color(0xff1BAC4B);
  static const Color switchDarkColor = Color(0xff1B5E20);

  static const Color scaffoldColor = Color(0xffeeefee);
  ...
  // Color themeColor = const Color(0xff201928);
  // Color primoTheme = const Color(0xff474972);

  // const Color primaryDarkColor = Color(0XFFE64A19);
  // const Color primaryLightColor = Color(0XFF80DEEA);
