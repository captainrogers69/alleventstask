          ...
          child: Column(
            ...
            children: [
              ...
              AuthButton(
                ...
                onTap: () async {
                  await ref.read(authViewProvider).validateLogin(
                      password: password, signgingUp: true, email: email);
                },
              ),
              const Sbh(h: 10),
              const OrDivider(title: "Or signup with one of the following"),
              AuthButton(
